...
import warningImg from "public/images/in-progress.svg";
  ...
  return (
    <div>
      ...
      {order.status === "wait-for-pay" && (
        <div className="flex flex-col items-center justify-center border-b-[1px] border-solid border-b-secondary-dark-200 p-[1rem] dark:border-b-secondary-dark-800 md:flex-row md:items-center md:justify-between">
          <Typography
            variant="body1"
